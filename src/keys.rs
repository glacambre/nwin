...
pub fn nvim_event_representation (event: Event) -> Option<String> {
    if let Event::KeyDown { keycode: Some(k), keymod: m, .. } = event {
        // We match over all keycodes, avoiding the catch-all clause
        // Thus we'll know when new keycodes are added (shouldn't ever happen though, right?)
        match k {
            // Alpha
            ...
            Keycode::AudioMute => None,
            Keycode::AudioNext => None,
            Keycode::AudioPlay => None,
            Keycode::AudioPrev => None,
            Keycode::AudioStop => None,
            ...
            Keycode::DisplaySwitch => None,
            Keycode::Eject => None,
            Keycode::ExSel => None,
            Keycode::Execute => None,
            Keycode::Find => None,
            Keycode::KbdIllumDown => None,
            Keycode::KbdIllumToggle => None,
            Keycode::KbdIllumUp => None,
